## Version: v3.34.6
## Date: 2021-04-29
## Update Content: 增加CASH_EXCHANGE变量，控制京东领现金是否把红包兑换成京豆，默认开启，如介意的请改成false【上次更新:由于lxk重新建库导致仓库更新失败,需要删掉映射出来的scripts文件夹，重新更新，https://github.com/dockere/jd-base 】

## 上面版本号中，如果第2位数字有变化，那么代表增加了新的参数，如果只有第3位数字有变化，仅代表更新了注释，没有增加新的参数，可更新可不更新
## 如需更新，请参考（https://github.com/dockere/jd-base）。

################################## 说明 ##################################
## 以下配置中，带有 export 申明的，均由lxk0301大佬定义，详见：https://gitee.com/lxk0301/jd_docker/blob/master/githubAction.md
...
## 2. 还可以通过浏览器开发工具获取，此方式获得的Cookie只有1个月有效期，教程：https://gitee.com/lxk0301/jd_docker/blob/master/backUp/GetJdCookie.md
...
## 关闭通知，那么请在下方填入0
## 简洁通知，那么请在下方填入1，其效果见：https://github.com/lxk0301/jd_scripts/blob/master/icon/bean_sign_simple.jpg
